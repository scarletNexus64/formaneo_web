    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Impossible de charger les informations d'activation</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        >
          ...
          {/* Price */}
          <div className="inline-flex items-center px-6 py-3 bg-white rounded-lg shadow-md border">
        ...
        >
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Statut actuel de votre compte</h3>
