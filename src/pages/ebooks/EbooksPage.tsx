          ...
          <div className={viewMode === 'grid' ? "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" : "space-y-4"}>
            {Array.from({ length: 6 }).map((_, index) => (
              <div key={index} className={`bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden ${
                ...
                <div className={`bg-gray-200 dark:bg-gray-600 ${viewMode === 'list' ? 'w-32 h-40' : 'h-48'}`}></div>
                {viewMode === 'list' && (
            ...
            {filteredEbooks.map((ebook) => {
              if (viewMode === 'list') {
                return (
                  ...
                  >
                    <div
                      className="group bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-indigo-200 dark:hover:border-indigo-700 hover:shadow-md p-6 flex gap-6"
                    >
                      ...
                      <div className="flex items-center gap-3">
                        {ebook.is_purchased ? (
                          <button
                            ...
                            className="flex items-center px-4 py-2 bg-primary-600 dark:bg-primary-700 text-white text-sm font-medium rounded-lg hover:bg-primary-700 dark:hover:bg-primary-600"
                          >
