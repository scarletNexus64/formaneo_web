        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            ...
            <div className="flex items-start mb-4">
              ...
              <div className="flex-1">
                ...
                <div className="prose prose-blue max-w-none text-gray-700">
                  <p className="mb-4">
                    Les présentes Conditions Générales d'Utilisation (CGU) ont pour objet de définir les modalités d'accès et d'utilisation du site web <strong>www.formaneo.site</strong>, exploité par <strong>FORMENAO SARL</strong>, société spécialisée dans la formation en ligne et les services éducatifs numériques.
                  </p>
              ...
              <div className="flex-1">
                ...
                <div className="prose prose-blue max-w-none text-gray-700">
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>Le coût de l'activation est fixé à <strong>5 500 FCFA</strong>, valable pour une durée d'un (1) mois, renouvelable à tout moment.</li>
          ...
          <section className="mb-10">
            <div className="flex items-start mb-4">
              ...
              <div className="flex-1">
                ...
                <div className="prose prose-blue max-w-none text-gray-700">
                  <h3 className="text-lg font-semibold text-gray-800 mt-4 mb-2">Nature des quiz</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mt-4 mb-2">Récompenses éducatives</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mt-4 mb-2">Conditions d'accès aux récompenses</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mt-4 mb-2">Finalité éducative</h3>
                  <p>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>Les commissions sont calculées comme suit :
                      <ul className="list-circle pl-6 mt-2 space-y-1">
                        <li><strong>Niveau 1 :</strong> 2 000 FCFA pour chaque filleul ayant activé son compte.</li>
                        <li><strong>Niveau 2 :</strong> 1 000 FCFA pour chaque filleul de niveau 2 ayant activé son compte.</li>
                      </ul>
                    </li>
                    <li>Les commissions d'affiliation sont versées uniquement après confirmation du paiement d'activation du filleul.</li>
                    <li className="text-red-600 font-semibold">Toute tentative de fraude, d'inscription multiple ou de manipulation des liens d'affiliation entraînera la suspension immédiate du compte concerné.</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <section className="mb-10">
            <div className="flex items-start mb-4">
              ...
              <div className="flex-1">
                ...
                <div className="prose prose-blue max-w-none text-gray-700">
                  <ul className="list-disc pl-6 space-y-2">
                    <li>Après activation, chaque utilisateur reçoit un bonus de bienvenue de <strong>2 000 FCFA</strong>, sous forme de crédit interne Formaneo.</li>
          ...
          <section className="mb-10">
            <div className="flex items-start mb-4">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Retraits et seuil de retrait</h2>
                <div className="prose prose-blue max-w-none text-gray-700">
                  <ul className="list-disc pl-6 space-y-2">
                    <li>Le seuil unique de retrait est fixé à <strong>2 000 FCFA</strong>.</li>
          ...
          <section className="mb-10">
            <div className="flex items-start mb-4">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Certificats et bourses</h2>
                <div className="prose prose-blue max-w-none text-gray-700">
                  <ul className="list-disc pl-6 space-y-2">
          ...
          <section className="mb-10">
            <div className="flex items-start mb-4">
              ...
              <div className="flex-1">
                ...
                <div className="prose prose-blue max-w-none text-gray-700">
                  <ul className="list-disc pl-6 space-y-2">
                    <li>Formaneo collecte et traite les données personnelles conformément à la <Link to="/legal/privacy-policy" className="text-blue-600 hover:text-blue-700 underline">politique de confidentialité</Link> disponible sur le site.</li>
            ...
            <div className="flex items-start mb-4">
              ...
              <div className="flex-1">
                ...
                <div className="prose prose-blue max-w-none text-gray-700">
                  ...
                  <div className="bg-gray-50 rounded-lg p-6 mb-4">
                    <h3 className="text-lg font-semibold text-gray-800 mb-3">Hébergeur du site :</h3>
                    <ul className="space-y-1 text-gray-700">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2">Propriété intellectuelle</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2">Juridiction compétente</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-2">Politique de remboursement</h3>
                  <p>
