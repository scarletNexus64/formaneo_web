...
const AccountActivationBanner: React.FC = () => {
  ...
  // Don't show banner for active or suspended accounts
  if (!user || user.account_status === 'active' || user.account_status === 'suspended') {
    return null;
  }
            ...
            <div>
              ...
              <p className="text-xs text-orange-100">
                {isExpired
                  ...
                  : isPendingPayment && !user.welcome_bonus_claimed
